                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">الاسم</label><input type="text"
                                class="form-control" name="name" placeholder="name" value="{{ $user->name }}">
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">النوع</label><input type="text"
                                class="form-control" placeholder="gender" name="gender"
                                value="{{ $user->userinfo->gender }}"></div>
                        <div class="col-md-12"><label class="labels">السن</label><input type="text"

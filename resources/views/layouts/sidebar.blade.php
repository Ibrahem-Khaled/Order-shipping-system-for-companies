...
<div class="collapse navbar-collapse w-auto" style="height: 100vh" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link  active" href="{{ route('CompanyHome') }}">
                <div
                ...
                <span class="nav-link-text ms-1">Al Amjad Multi</span>
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('getEmployee') }}">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">ادارة الموظفين</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('flatbeds.index') }}">
                <span class="nav-link-text ms-1">ادارة السطحات</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('thanks.god') }}" onclick="return checkPassword(event);">
                ...
                <span class="nav-link-text ms-1">الحمد لله</span>
            </a>
        </li>

...
class CompanyController extends Controller
{
    public function index()
    {
        ...
        return view('Company.index', compact('container', 'deposit', 'withdraw'));
    }
    public function companyDetailes()
    {
        $container = Container::all();
        return view('Company.companyDetailes', compact('container'));
    }
    public function companyRevExp()
    {
        ...
        // return response()->json($uniqueEmployeeIds);
        $elbancherSum = 0;
